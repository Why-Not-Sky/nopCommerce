    ...
    public partial class PriceCalculationService : IPriceCalculationService
    {
            ...
            out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            var cachedPrice = _cacheManager.Get(cacheKey, cacheTime, () =>
            {
                ...
                //advanced pricing
                price = product.GetAppropriateAdvancedPrice(customer, _storeContext.CurrentStore.Id, quantity) ?? price;
            ...
            out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            else
            {
                ...
                {
                    int qty;
                    if (_shoppingCartSettings.GroupAdvancedPricesForDistinctShoppingCartItems)
                    {
